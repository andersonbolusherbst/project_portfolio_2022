...
if option == "Analytics":
    ...
    st.write("")     
    st.markdown("""
    <iframe src="https://datastudio.google.com/embed/reporting/f48f602f-2542-4ad6-ad15-f1bc9c6a6ff1/page/p_ex3znh92oc" width="80%" height="80%" frameborder="0" allowfullscreen="true"></iframe>
""", unsafe_allow_html=True)
