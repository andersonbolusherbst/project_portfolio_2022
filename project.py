...
if option == "Home":
  st.image("HAB LABS.png")
  st.markdown("<h1 style='text-align: center; color: blue;'>WE HELP COMPANIES GROW</h1>", unsafe_allow_html=True)
  st.write("")
  st.markdown("<h4 style='text-align: center; color: blue;'>Become data-driven today and scale your business.We take the time to understand your business and how data can help you to achieve your goals.</h4>", unsafe_allow_html=True)
